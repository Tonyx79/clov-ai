...
//!
//! Provides common helpers used across clov commands:
...
/// # Examples
/// ```no_run
/// use clov::utils::execute_command;
...
/// # Examples
/// ```
/// use clov::utils::join_with_overflow;
...
/// # Examples
/// ```
/// use clov::utils::truncate_iso_date;
...
/// # Examples
/// ```
/// use clov::utils::ok_confirmation;
...
/// # Examples
/// ```no_run
/// use clov::utils::detect_package_manager;
...
mod tests {
    ...
    fn test_detect_package_manager_default() {
        // In the test environment (clov repo), there's no JS lockfile
