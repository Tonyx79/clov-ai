...
_CLOV includes work derived from [RTK](https://github.com/rtk-ai/rtk/), extended with a Rust implementation, MCP proxy support, structured-response filtering, dynamic truncation controls, and local telemetry._
