...
- Startup time optimization (<10ms target for CLOV)
...
- **Framework Patterns**: Respect established patterns (e.g., CLOV filter design, lazy_static regex)
...
## CLOV-Specific Review Checklist

When reviewing CLOV code, always verify:
...
- [ ] **No async**: CLOV is single-threaded, no tokio/async-std
